...
export interface StoreRequest { executable: string; args: string[]; env: NodeJS.ProcessEnv; signal?: AbortSignal | undefined }
...
export async function credentialCapability(ref: CredentialReference, context: CredentialContext = {}): Promise<{ available: boolean; executable?: string }> {
